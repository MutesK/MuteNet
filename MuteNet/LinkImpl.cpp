...
namespace MuteNet
{
	...
	LinkImpl::LinkImpl ( const CallbacksPtr LinkCallback )
			: super ( LinkCallback ), _LocalPort ( 0 ), _RemotePort ( 0 ), _ASyncIORequestCounter ( 0 ),
			  _isShutdown ( false ),
	...
	LinkImpl::LinkImpl ( intptr_t socket, const CallbacksPtr LinkCallback, const ServerHandleImplPtr ServerHandlePtr,
			...
			: super ( LinkCallback ), _Server ( ServerHandlePtr ), _LocalPort ( 0 ), _RemotePort ( 0 ),
			  _isShutdown ( false ),
